...
def test_merge_files(setup_test_environment):
    ...
    assert len(merged_data) == len(setup_test_environment.part1_data), "Merged data should have same length as Part 1"
...
def test_write_merged_file(setup_test_environment):
    ...
    assert os.path.exists(setup_test_environment.output_path), "Merged CSV file should be created"